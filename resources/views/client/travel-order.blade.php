    ...
    <div class="printable-folio bg-white mx-auto shadow-lg print:shadow-none mb-4">
        ...
        <div class="ticket-container">
            ...
            <div class="text-[11pt] leading-none space-y-4">
                ...
                {{-- WRAPPER FOR DETAILS: This moves to page 2 automatically if the above list is too long --}}
                <div class="details-footer space-y-4 pt-6">
                    ...
                    <div class="space-y-2">
                        ...
                        'Appropriation to which travel should be charged:' => $travelOrder->appropriation ?? '',
